...
data modify storage sb:tmp name set string storage sb:tmp name 0 -1
execute store result storage sb:tmp tmp.i int 1 run scoreboard players set #i sb.tmp -1
execute store result storage sb:tmp tmp.i1 int 1 run scoreboard players remove #i sb.tmp 1
