tellraw @s ["\n", \
	...
	{text:"For more info and extended explanation, click here.\n", color:"blue", underlined: true, italic: true, click_event:{action:"open_url",url:"https://github.com/Plagiatus/Statistic-Books-MC"}, hover_event: {action: "show_text", value:["github.com/Plagiatus/Statistic-Books-MC"]}}, \
...
execute if score refreshType sb.settings matches 1 run tellraw @s ["", \
	...
	{text: "/trigger sb.update", underlined: true, click_event: {action: "suggest_command", command: "/trigger sb.update"}}, \
	"."]
...
execute if score autoOptIn sb.settings matches 0 run tellraw @s ["", \
	{text: "Opting in/out\n", color:"yellow", bold: true}, \
	"Using ", {text: "/trigger sb.optin", underlined: true, click_event: {action: "suggest_command", command: "/trigger sb.optin"}}, \
...
execute if score allowSecret sb.settings matches 1 run tellraw @s ["", \
	...
	{text: "/trigger sb.secret", underlined: true, click_event: {action: "suggest_command", command: "/trigger sb.secret"}}, \
	"."]
